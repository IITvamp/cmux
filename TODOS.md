...
[ ] support making new projects well
[ ] handle new repos well
[ ] support empty HEAD commit/missing branch
[ ] make it clearer that starting task will create a new branch.
[ ] flash of white theme when loading dark mode
