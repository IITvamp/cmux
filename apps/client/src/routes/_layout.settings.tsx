...
function SettingsComponent() {
  ...
  // Crown Evaluator setting removed; auto PR is always disabled
  ...
  useEffect(() => {
    if (workspaceSettings !== undefined) {
      ...
      // autoPrEnabled is permanently disabled; ignore any stored value
    }
  }, [workspaceSettings]);
      ...
      >
        <div className="p-6 max-w-3xl">
          ...
          <div className="space-y-4">
            ...
            {/* Crown Evaluator removed; auto-PR is always disabled */}
