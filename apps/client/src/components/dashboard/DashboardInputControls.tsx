          ...
          <div className="flex flex-wrap gap-1">
            {sortedSelectedAgents.map((agent) => {
              ...
              return (
                <div
                  key={agent}
                  className="inline-flex items-center gap-1 rounded-full bg-neutral-200 dark:bg-neutral-800/80 pl-1.5 pr-2 py-1.5 text-[11px] text-neutral-700 dark:text-neutral-200 transition-colors"
                >
                  <button
                    type="button"
                    onClick={(event) => {
