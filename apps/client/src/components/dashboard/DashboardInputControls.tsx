          ...
          <div className="flex flex-wrap gap-1">
            {sortedSelectedAgents.map((agent) => {
              ...
              return (
                <div
                  key={agent}
                  className="inline-flex items-center gap-1 rounded-full bg-neutral-200 dark:bg-neutral-800/80 pr-2 pl-1 py-1 text-[11px] text-neutral-700 dark:text-neutral-200 transition-colors"
                >
                  <button
                    type="button"
                    onClick={(event) => {
