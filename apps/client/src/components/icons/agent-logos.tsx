...
function fallbackBadge(provider: string, className?: string) {
  const colors: Record<string, { bg: string; fg: string; label: string }> = {
    ...
    other: { bg: "#6B7280", fg: "#ffffff", label: provider[0]?.toUpperCase() || "?" },
  };
...
export const AgentLogo = memo(function AgentLogo({ agentName, className }: AgentLogoProps) {
  const vendor = inferVendor(agentName);

  if (vendor === "openai") {
    return (
      <svg viewBox="118 120 480 480" className={className} fill="currentColor" aria-hidden>
  ...
  if (vendor === "gemini") {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={className} aria-hidden>
        ...
        />
        <defs>
          <radialGradient id="gemini_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(16.1326 5.4553 -43.70045 129.2322 1.588 6.503)">
  ...
  if (vendor === "cursor") {
    return (
      <svg viewBox="0 0 24 24" className={className} aria-hidden>
        <defs>
          <linearGradient id="cursor_grad0" x1="11.925" x2="11.925" y1="12" y2="24" gradientUnits="userSpaceOnUse">
            <stop offset=".16" stopColor="#000" stopOpacity=".39" />
            <stop offset=".658" stopColor="#000" stopOpacity=".8" />
          </linearGradient>
          <linearGradient id="cursor_grad1" x1="22.35" x2="11.925" y1="6.037" y2="12.15" gradientUnits="userSpaceOnUse">
            <stop offset=".182" stopColor="#000" stopOpacity=".31" />
            <stop offset=".715" stopColor="#000" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="cursor_grad2" x1="11.925" x2="1.5" y1="0" y2="18" gradientUnits="userSpaceOnUse">
            <stop stopColor="#000" stopOpacity=".6" />
            <stop offset=".667" stopColor="#000" stopOpacity=".22" />
          </linearGradient>
        </defs>
        <path d="M11.925 24l10.425-6-10.425-6L1.5 18l10.425 6z" fill="url(#cursor_grad0)" />
        <path d="M22.35 18V6L11.925 0v12l10.425 6z" fill="url(#cursor_grad1)" />
        <path d="M11.925 0L1.5 6v12l10.425-6V0z" fill="url(#cursor_grad2)" />
  ...
  if (vendor === "glm") {
    return (
      <svg viewBox="0 0 24 24" className={className} aria-hidden>
        <path d="M12.105 2L9.927 4.953H.653L2.83 2h9.276zM23.254 19.048L21.078 22h-9.242l2.174-2.952h9.244zM24 2L9.264 22H0L14.736 2H24z" fill="currentColor" fillRule="evenodd" />
      </svg>
    );
  }
  if (vendor === "kimi") {
    return (
      <svg viewBox="0 0 24 24" className={className} aria-hidden>
        <path d="M19.738 5.776c.163-.209.306-.4.457-.585.07-.087.064-.153-.004-.244-.655-.861-.717-1.817-.34-2.787.283-.73.909-1.072 1.674-1.145.477-.045.945.004 1.379.236.57.305.902.77 1.01 1.412.086.512.07 1.012-.075 1.508-.257.878-.888 1.333-1.753 1.448-.718.096-1.446.108-2.17.157-.056.004-.113 0-.178 0z" fill="#027AFF" />
        <path d="M17.962 1.844h-4.326l-3.425 7.81H5.369V1.878H1.5V22h3.87v-8.477h6.824a3.025 3.025 0 002.743-1.75V22h3.87v-8.477a3.87 3.87 0 00-3.588-3.86v-.01h-2.125a3.94 3.94 0 002.323-2.12l2.545-5.689z" fill="currentColor" fillRule="evenodd" />
      </svg>
    );
  }
  if (vendor === "grok") {
    return (
      <svg viewBox="0 0 33 32" className={className} fill="currentColor" aria-hidden>
