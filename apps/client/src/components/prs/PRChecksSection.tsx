...
export function PRChecksSection(props: PRChecksSectionProps) {
  ...
  const [checksExpandedOverride, setChecksExpandedOverride] = useState<boolean | null>(
    null
  );
