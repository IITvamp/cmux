    ...
    <div className="flex items-stretch">
      ...
      <DropdownMenu.Root open={dropdownOpen} onOpenChange={setDropdownOpen}>
        <DropdownMenu.Trigger asChild>
          <button
            disabled={disabled}
            className="flex items-center px-2 py-1 bg-green-600 text-white rounded-r hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed select-none"
          >
