...
const BASE_PROSE_CLASSES =
  ...
  " dark:prose-blockquote:border-neutral-600 prose-blockquote:pl-4" +
  " prose-blockquote:py-0.5 prose-blockquote:my-2" +
  ...
  " prose-pre:text-neutral-100 prose-pre:p-3 prose-pre:rounded-md" +
  " prose-pre:my-2 prose-pre:overflow-x-auto" +
  " prose-a:text-blue-600 dark:prose-a:text-blue-400 prose-a:underline" +
  " prose-a:break-words" +
  " prose-table:my-2 prose-table:border prose-table:border-neutral-300" +
  " dark:prose-table:border-neutral-600" +
  " prose-th:p-2 prose-th:bg-neutral-100 dark:prose-th:bg-neutral-800" +
  " prose-td:p-2 prose-td:border prose-td:border-neutral-300" +
...
export function MarkdownProse({ content, className }: MarkdownProseProps) {
  ...
  return (
    <div className={cn(BASE_PROSE_CLASSES, className)}>
