    ...
    <div className="w-64 bg-neutral-50 dark:bg-black flex flex-col shrink-0">
      ...
      <div className="p-4 border-t border-neutral-200 dark:border-neutral-800">
        <a
          ...
          className="flex items-center px-3 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-colors select-none cursor-default mb-2"
        >
          <svg
