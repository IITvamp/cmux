...
import { TaskTreeSkeleton } from "./TaskTreeSkeleton";
...
export function Sidebar({ tasks, tasksWithRuns, isElectron }: SidebarProps) {
  return (
    <div className="w-64 bg-neutral-50 dark:bg-black flex flex-col shrink-0">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-1">
          ...
          <div className="space-y-0.5">
            {tasks === undefined ? (
              ...
              tasksWithRuns
                .slice(0, 10)
                .map((task: any) => <TaskTree key={task._id} task={task} />)
            ) : (
      ...
      <div className="px-4 pt-2">
        <a
          ...
          className="flex items-center px-3 py-2 mb-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-colors select-none cursor-default border border-neutral-200 dark:border-neutral-700"
        >
          <svg
