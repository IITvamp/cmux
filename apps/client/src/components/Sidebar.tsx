    ...
    >
      ...
      <div className="pb-2 shrink-0 flex flex-col">
        ...
        <button
          ...
          className="w-full flex items-center px-7 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors select-none cursor-pointer text-left"
        >
          <svg
            className="w-4 h-4 mr-3 text-neutral-500"
            fill="none"
