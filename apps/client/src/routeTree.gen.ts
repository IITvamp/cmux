...
import { Route as DebugWcvRouteImport } from './routes/debug-wcv'
...
const DebugWcvRoute = DebugWcvRouteImport.update({
  id: '/debug-wcv',
  path: '/debug-wcv',
...
export interface FileRoutesByFullPath {
  ...
  '/debug-wcv': typeof DebugWcvRoute
...
export interface RootRouteChildren {
  ...
  DebugWcvRoute: typeof DebugWcvRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/debug-wcv': {
      ...
      path: '/debug-wcv'
      fullPath: '/debug-wcv'
      preLoaderRoute: typeof DebugWcvRouteImport
