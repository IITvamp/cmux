...
export const resolveTeamAndSnapshot = async ({
  ...
  if (environmentId) {
    ...
    return {
      ...
      environment: {
        maintenanceScript: environmentDoc.maintenanceScript ?? undefined,
        devScript: environmentDoc.devScript ?? undefined,
        exposedPorts: environmentDoc.exposedPorts ?? undefined,
      },
    };
  }
