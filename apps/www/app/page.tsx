              ...
              <div className="mt-10 flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 h-10 px-3 rounded-md border border-neutral-300/60 bg-white/70 text-neutral-800 transition-colors hover:bg-white/85 dark:border-neutral-800 dark:bg-neutral-900/70 dark:text-neutral-100 dark:hover:bg-neutral-900"
                  >
                    <ClientIcon
                      icon={Star}
                      className="h-4 w-4"
