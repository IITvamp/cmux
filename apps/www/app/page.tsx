                ...
                <ul className="flex flex-wrap items-center gap-x-2">
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md border border-neutral-700 text-neutral-300 hover:text-white hover:border-neutral-500 transition"
                      aria-label="Star cmux on GitHub"
                    >
