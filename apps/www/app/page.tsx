            ...
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 h-12 border border-neutral-800 text-neutral-200 bg-neutral-950/50 hover:bg-neutral-900 rounded-lg font-medium transition-colors"
                >
                  <ClientIcon
                    icon={Star}
                    className="h-5 w-5"
