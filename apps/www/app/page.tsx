            ...
            <div>
              <div className="mb-8 flex flex-col sm:flex-row items-center gap-4">
                <a
                  ...
                  className="inline-flex h-14 items-center gap-2 text-lg font-semibold text-black bg-white hover:bg-neutral-50 border border-neutral-800 rounded-lg px-6 transition-all whitespace-nowrap shadow-lg"
                >
                  <svg
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 h-14 bg-neutral-900 text-white border border-neutral-800 hover:bg-neutral-800 rounded-lg font-semibold text-lg transition-colors"
                >
                  <svg
                    className="h-6 w-6"
                    aria-hidden="true"
