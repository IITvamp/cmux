                ...
                <ul className="flex flex-wrap items-center gap-x-2">
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex h-8 items-center gap-1.5 rounded-md border border-neutral-800 bg-neutral-950/60 px-3 text-sm font-medium text-neutral-300 hover:bg-neutral-900 hover:text-white transition-colors"
                    >
                      <ClientIcon icon={Star} className="h-3.5 w-3.5" aria-hidden="true" />
