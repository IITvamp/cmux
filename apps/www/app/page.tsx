          ...
          <div className="grid grid-cols-[4px_1fr] gap-6">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-300 mb-4 leading-relaxed">
                cmux is an AI workflow builder that helps businesses automate complex development tasks using Claude Code, Codex, Gemini CLI, Amp,
                Opencode, and other coding agents. Build scalable AI workflows that run in parallel, with full verification and control at every step.
              </p>
              <p className="text-lg text-neutral-300 mb-4 leading-relaxed">
                Every workflow runs in isolated VS Code instances via Docker with git diff UI and terminal, ensuring your business-critical code
                remains verifiable, auditable, and production-ready.
              </p>
