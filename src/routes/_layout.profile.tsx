  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-start space-x-6 mb-6">
              <div className="relative">
                <div className="w-24 h-24 bg-neutral-200 dark:bg-neutral-800 rounded-full flex items-center justify-center">
                  <span className="text-3xl text-neutral-500 dark:text-neutral-400">JD</span>
                </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="pt-2">
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                As an admin, you have full access to all workspace features and
        ...
        <div className="bg-white dark:bg-neutral-950 rounded-lg border border-neutral-200 dark:border-neutral-800">
          <div className="px-6 py-4 border-b border-neutral-200 dark:border-neutral-800">
            <h2 className="text-base font-medium text-neutral-900 dark:text-neutral-100">Security</h2>
          </div>
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div>
