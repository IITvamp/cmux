...
# CI macOS arm64 build + sign + notarize for Electron app
# Mirrors the steps in .github/workflows/release-updates.yml (mac-arm64 job) without reusing local scripts
