...
def ensure_docker(snapshot: Snapshot) -> Snapshot:
    ...
    snapshot = snapshot.exec(
        ...
        "binutils sudo build-essential bzr curl default-libmysqlclient-dev "
        ...
        "libffi-dev libgcc-13-dev libgdbm-compat-dev libgdbm-dev libgdiplus "
        ...
        "libstdc++-13-dev libunwind8 libuuid1 libxml2-dev libz3-dev make "
        "moreutils netcat-openbsd openssh-client pkg-config protobuf-compiler "
        "ripgrep rsync software-properties-common sqlite3 swig3.0 tk-dev "
        "tzdata unixodbc-dev unzip uuid-dev wget xz-utils zip zlib1g "
        "zlib1g-dev ca-certificates bash python3 procps htop "
