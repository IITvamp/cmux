...
# Create macOS entitlements file for Electron signing if it doesn't exist.
# This writes to apps/client/build/entitlements.mac.plist to match electron-builder config.
