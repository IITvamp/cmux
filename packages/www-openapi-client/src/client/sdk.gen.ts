 ...
 */
export const getApiIntegrationsGithubSetup = <ThrowOnError extends boolean = false>(options: Options<GetApiIntegrationsGithubSetupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetApiIntegrationsGithubSetupErrors, ThrowOnError>({
 ...
 */
export const getApiGithubSetup = <ThrowOnError extends boolean = false>(options: Options<GetApiGithubSetupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetApiGithubSetupErrors, ThrowOnError>({
