 ...
 */
export const postApiIntegrationsGithubPrsMergeDirect = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsMergeDirectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsMergeDirectResponses, PostApiIntegrationsGithubPrsMergeDirectErrors, ThrowOnError>({
        url: '/api/integrations/github/prs/merge-direct',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
 ...
 */
export const postApiIntegrationsGithubPrsCloseDirect = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsCloseDirectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsCloseDirectResponses, PostApiIntegrationsGithubPrsCloseDirectErrors, ThrowOnError>({
        url: '/api/integrations/github/prs/close-direct',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
