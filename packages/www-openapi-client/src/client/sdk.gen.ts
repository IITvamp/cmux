...
/**
 * Fetch the latest GitHub release for cmux
 */
export const getApiIntegrationsGithubReleasesLatest = <ThrowOnError extends boolean = false>(options?: Options<GetApiIntegrationsGithubReleasesLatestData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiIntegrationsGithubReleasesLatestResponses, GetApiIntegrationsGithubReleasesLatestErrors, ThrowOnError>({
