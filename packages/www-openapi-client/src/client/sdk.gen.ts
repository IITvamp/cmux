 ...
 */
export const postApiIntegrationsGithubPrsByOwnerByRepoByNumberMerge = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeResponses, PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeErrors, ThrowOnError>({
