 ...
 */
export const postApiApiIntegrationsGithubPrsSyncChecks = <ThrowOnError extends boolean = false>(options: Options<PostApiApiIntegrationsGithubPrsSyncChecksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiApiIntegrationsGithubPrsSyncChecksResponses, PostApiApiIntegrationsGithubPrsSyncChecksErrors, ThrowOnError>({
 ...
 */
export const postApiApiIntegrationsGithubChecksBackfill = <ThrowOnError extends boolean = false>(options: Options<PostApiApiIntegrationsGithubChecksBackfillData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiApiIntegrationsGithubChecksBackfillResponses, PostApiApiIntegrationsGithubChecksBackfillErrors, ThrowOnError>({
 ...
 */
export const getApiApiIntegrationsGithubWorkflowRuns = <ThrowOnError extends boolean = false>(options: Options<GetApiApiIntegrationsGithubWorkflowRunsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiApiIntegrationsGithubWorkflowRunsResponses, GetApiApiIntegrationsGithubWorkflowRunsErrors, ThrowOnError>({
 ...
 */
export const getApiApiIntegrationsGithubWorkflowRunsPr = <ThrowOnError extends boolean = false>(options: Options<GetApiApiIntegrationsGithubWorkflowRunsPrData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiApiIntegrationsGithubWorkflowRunsPrResponses, GetApiApiIntegrationsGithubWorkflowRunsPrErrors, ThrowOnError>({
