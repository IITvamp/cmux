 ...
 */
export const postApiSandboxesByIdHydrate = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesByIdHydrateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesByIdHydrateResponses, PostApiSandboxesByIdHydrateErrors, ThrowOnError>({
