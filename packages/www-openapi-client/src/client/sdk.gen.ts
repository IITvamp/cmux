 ...
 */
export const postApiIntegrationsGithubPrsByOwnerByRepoByNumberClose = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseResponses, PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseErrors, ThrowOnError>({
