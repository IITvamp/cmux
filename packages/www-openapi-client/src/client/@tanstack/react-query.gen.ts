...
import { type Options, getApiHealth, getApiUsers, postApiUsers, deleteApiUsersById, getApiUsersById, patchApiUsersById, getApiBooks, postApiBooks, getApiBooksById, postApiBooksByIdBorrow, postApiBooksByIdReturn, postApiDevServerStart, getApiIntegrationsGithubRepos, getApiIntegrationsGithubReleasesLatest, getApiIntegrationsGithubPrs, postApiIntegrationsGithubPrsBackfill, postApiIntegrationsGithubPrsBackfillRepo, getApiIntegrationsGithubPrsCode, postApiIntegrationsGithubPrsOpen, getApiIntegrationsGithubPrsRaw, getApiIntegrationsGithubPrsFiles, getApiIntegrationsGithubPrsFileContents, postApiIntegrationsGithubPrsFileContentsBatch, postApiMorphSetupInstance, getApiEnvironments, postApiEnvironments, deleteApiEnvironmentsById, getApiEnvironmentsById, getApiEnvironmentsByIdVars, patchApiEnvironmentsByIdPorts, getApiEnvironmentsByIdSnapshots, postApiEnvironmentsByIdSnapshots, postApiEnvironmentsByIdSnapshotsBySnapshotVersionIdActivate, postApiSandboxesStart, postApiSandboxesByIdEnv, postApiSandboxesByIdStop, getApiSandboxesByIdStatus, postApiSandboxesByIdPublishDevcontainer, postApiTeams } from '../sdk.gen.js';
...
export const getApiIntegrationsGithubReleasesLatestQueryKey = (options?: Options<GetApiIntegrationsGithubReleasesLatestData>) => createQueryKey('getApiIntegrationsGithubReleasesLatest', options);

/**
 * Fetch the latest GitHub release for cmux
 */
export const getApiIntegrationsGithubReleasesLatestOptions = (options?: Options<GetApiIntegrationsGithubReleasesLatestData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubReleasesLatest({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubReleasesLatestQueryKey(options)
    });
};
