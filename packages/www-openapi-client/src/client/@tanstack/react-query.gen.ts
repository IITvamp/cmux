...
/**
 * Merge a GitHub pull request via the cmux GitHub App
 */
...
/**
 * Close a GitHub pull request via the cmux GitHub App
 */
export const postApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseData>>): UseMutationOptions<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseResponse, DefaultError, Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseResponse, DefaultError, Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberCloseData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsByOwnerByRepoByNumberClose({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
