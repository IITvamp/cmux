...
export const getApiIntegrationsGithubSetupQueryKey = (options: Options<GetApiIntegrationsGithubSetupData>) => createQueryKey('getApiIntegrationsGithubSetup', options);

/**
 * GitHub App Setup URL handler
 */
export const getApiIntegrationsGithubSetupOptions = (options: Options<GetApiIntegrationsGithubSetupData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubSetup({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubSetupQueryKey(options)
    });
};

export const getApiGithubSetupQueryKey = (options: Options<GetApiGithubSetupData>) => createQueryKey('getApiGithubSetup', options);

/**
 * GitHub App Setup URL handler (alias)
 */
export const getApiGithubSetupOptions = (options: Options<GetApiGithubSetupData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiGithubSetup({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiGithubSetupQueryKey(options)
    });
};
 ...
 */
export const postApiMorphProvisionInstanceMutation = (options?: Partial<Options<PostApiMorphProvisionInstanceData>>): UseMutationOptions<PostApiMorphProvisionInstanceResponse, DefaultError, Options<PostApiMorphProvisionInstanceData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphProvisionInstanceResponse, DefaultError, Options<PostApiMorphProvisionInstanceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphProvisionInstance({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiVscodeSettingsQueryKey = (options: Options<GetApiVscodeSettingsData>) => createQueryKey('getApiVscodeSettings', options);

/**
 * Get VS Code settings for user/team
 */
export const getApiVscodeSettingsOptions = (options: Options<GetApiVscodeSettingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiVscodeSettings({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiVscodeSettingsQueryKey(options)
    });
};
 ...
 */
export const postApiVscodeSettingsMutation = (options?: Partial<Options<PostApiVscodeSettingsData>>): UseMutationOptions<PostApiVscodeSettingsResponse, DefaultError, Options<PostApiVscodeSettingsData>> => {
    const mutationOptions: UseMutationOptions<PostApiVscodeSettingsResponse, DefaultError, Options<PostApiVscodeSettingsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiVscodeSettings({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
