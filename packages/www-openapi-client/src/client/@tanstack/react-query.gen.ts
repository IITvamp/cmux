...
/**
 * Merge a GitHub pull request for a team
 */
export const postApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeData>>): UseMutationOptions<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeResponse, DefaultError, Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeResponse, DefaultError, Options<PostApiIntegrationsGithubPrsByOwnerByRepoByNumberMergeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsByOwnerByRepoByNumberMerge({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const postApiCrownSummarizeMutation = (options?: Partial<Options<PostApiCrownSummarizeData>>): UseMutationOptions<PostApiCrownSummarizeResponse, DefaultError, Options<PostApiCrownSummarizeData>> => {
    const mutationOptions: UseMutationOptions<PostApiCrownSummarizeResponse, DefaultError, Options<PostApiCrownSummarizeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiCrownSummarize({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const postApiCrownEvaluateMutation = (options?: Partial<Options<PostApiCrownEvaluateData>>): UseMutationOptions<PostApiCrownEvaluateResponse, DefaultError, Options<PostApiCrownEvaluateData>> => {
    const mutationOptions: UseMutationOptions<PostApiCrownEvaluateResponse, DefaultError, Options<PostApiCrownEvaluateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiCrownEvaluate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
