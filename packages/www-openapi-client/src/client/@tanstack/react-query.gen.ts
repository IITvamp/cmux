...
import { type Options, getApiHealth, getApiUsers, postApiUsers, deleteApiUsersById, getApiUsersById, patchApiUsersById, getApiBooks, postApiBooks, getApiBooksById, postApiBooksByIdBorrow, postApiBooksByIdReturn, postApiDevServerStart, getApiIntegrationsGithubRepos, getApiIntegrationsGithubPrs, postApiIntegrationsGithubPrsClose, postApiIntegrationsGithubPrsBackfill, postApiIntegrationsGithubPrsBackfillRepo, getApiIntegrationsGithubPrsCode, getApiIntegrationsGithubPrsRaw, getApiIntegrationsGithubPrsFiles, getApiIntegrationsGithubPrsFileContents, postApiIntegrationsGithubPrsFileContentsBatch, getApiIntegrationsGithubUser, postApiMorphSetupInstance, getApiEnvironments, postApiEnvironments, deleteApiEnvironmentsById, getApiEnvironmentsById, getApiEnvironmentsByIdVars, postApiSandboxesStart, postApiSandboxesByIdEnv, postApiSandboxesByIdStop, getApiSandboxesByIdStatus, postApiSandboxesByIdPublishDevcontainer, postApiCrownSummarize, postApiCrownEvaluate, postApiTeams } from '../sdk.gen.js';
...
export const getApiIntegrationsGithubUserQueryKey = (options?: Options<GetApiIntegrationsGithubUserData>) => createQueryKey('getApiIntegrationsGithubUser', options);

/**
 * Get GitHub user id/login and (optionally) emails using user's OAuth token
 */
export const getApiIntegrationsGithubUserOptions = (options?: Options<GetApiIntegrationsGithubUserData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubUser({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubUserQueryKey(options)
    });
};
