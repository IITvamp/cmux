...
import { type Options, getApiHealth, getApiUsers, postApiUsers, deleteApiUsersById, getApiUsersById, patchApiUsersById, getApiBooks, postApiBooks, getApiBooksById, postApiBooksByIdBorrow, postApiBooksByIdReturn, postApiDevServerStart, getApiIntegrationsGithubRepos, postApiMorphSetupInstance, getApiEnvironments, postApiEnvironments, deleteApiEnvironmentsById, getApiEnvironmentsById, getApiEnvironmentsByIdVars, postApiSandboxesStart, postApiSandboxesByIdStop, getApiSandboxesByIdStatus, postApiSandboxesByIdHydrate, postApiSandboxesByIdPublishDevcontainer } from '../sdk.gen.js';
...
/**
 * Clone repo into sandbox workspace and checkout branches
 */
export const postApiSandboxesByIdHydrateMutation = (options?: Partial<Options<PostApiSandboxesByIdHydrateData>>): UseMutationOptions<PostApiSandboxesByIdHydrateResponse, DefaultError, Options<PostApiSandboxesByIdHydrateData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesByIdHydrateResponse, DefaultError, Options<PostApiSandboxesByIdHydrateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesByIdHydrate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
