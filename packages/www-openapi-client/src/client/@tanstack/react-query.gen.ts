...
/**
 * Close GitHub pull requests for a task run using the user's GitHub OAuth token
 */
 ...
 */
export const postApiIntegrationsGithubPrsMergeDirectMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsMergeDirectData>>): UseMutationOptions<PostApiIntegrationsGithubPrsMergeDirectResponse, DefaultError, Options<PostApiIntegrationsGithubPrsMergeDirectData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsMergeDirectResponse, DefaultError, Options<PostApiIntegrationsGithubPrsMergeDirectData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsMergeDirect({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiIntegrationsGithubPrsCloseDirectMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsCloseDirectData>>): UseMutationOptions<PostApiIntegrationsGithubPrsCloseDirectResponse, DefaultError, Options<PostApiIntegrationsGithubPrsCloseDirectData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsCloseDirectResponse, DefaultError, Options<PostApiIntegrationsGithubPrsCloseDirectData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsCloseDirect({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
