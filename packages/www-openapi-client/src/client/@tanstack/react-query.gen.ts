 ...
 */
export const postApiIntegrationsGithubPrsMergeMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsMergeData>>): UseMutationOptions<PostApiIntegrationsGithubPrsMergeResponse, PostApiIntegrationsGithubPrsMergeError, Options<PostApiIntegrationsGithubPrsMergeData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsMergeResponse, PostApiIntegrationsGithubPrsMergeError, Options<PostApiIntegrationsGithubPrsMergeData>> = {
        mutationFn: async (fnOptions) => {
