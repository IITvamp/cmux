...
/**
 * Sync checks for a PR
 * Fetch and sync workflow runs and check runs from GitHub for a specific PR
 */
export const postApiApiIntegrationsGithubPrsSyncChecksMutation = (options?: Partial<Options<PostApiApiIntegrationsGithubPrsSyncChecksData>>): UseMutationOptions<PostApiApiIntegrationsGithubPrsSyncChecksResponse, DefaultError, Options<PostApiApiIntegrationsGithubPrsSyncChecksData>> => {
    const mutationOptions: UseMutationOptions<PostApiApiIntegrationsGithubPrsSyncChecksResponse, DefaultError, Options<PostApiApiIntegrationsGithubPrsSyncChecksData>> = {
        mutationFn: async (fnOptions) => {
...
/**
 * Backfill historical checks
 * Fetch and persist historical workflow runs and check runs from GitHub for a repository or specific ref/PR
 */
export const postApiApiIntegrationsGithubChecksBackfillMutation = (options?: Partial<Options<PostApiApiIntegrationsGithubChecksBackfillData>>): UseMutationOptions<PostApiApiIntegrationsGithubChecksBackfillResponse, DefaultError, Options<PostApiApiIntegrationsGithubChecksBackfillData>> => {
    const mutationOptions: UseMutationOptions<PostApiApiIntegrationsGithubChecksBackfillResponse, DefaultError, Options<PostApiApiIntegrationsGithubChecksBackfillData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiApiIntegrationsGithubChecksBackfill({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiApiIntegrationsGithubWorkflowRunsQueryKey = (options: Options<GetApiApiIntegrationsGithubWorkflowRunsData>) => createQueryKey('getApiApiIntegrationsGithubWorkflowRuns', options);

/**
 * Get GitHub Actions workflow runs
 * Retrieve GitHub Actions workflow runs for a team, with optional filtering by repository and workflow
 */
export const getApiApiIntegrationsGithubWorkflowRunsOptions = (options: Options<GetApiApiIntegrationsGithubWorkflowRunsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiApiIntegrationsGithubWorkflowRuns({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiApiIntegrationsGithubWorkflowRunsQueryKey(options)
    });
};

export const getApiApiIntegrationsGithubWorkflowRunsPrQueryKey = (options: Options<GetApiApiIntegrationsGithubWorkflowRunsPrData>) => createQueryKey('getApiApiIntegrationsGithubWorkflowRunsPr', options);

/**
 * Get GitHub Actions workflow runs for a PR
 * Retrieve GitHub Actions workflow runs that were triggered by a specific pull request
 */
export const getApiApiIntegrationsGithubWorkflowRunsPrOptions = (options: Options<GetApiApiIntegrationsGithubWorkflowRunsPrData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiApiIntegrationsGithubWorkflowRunsPr({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiApiIntegrationsGithubWorkflowRunsPrQueryKey(options)
    });
};
