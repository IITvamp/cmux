...
const convexSchema = defineSchema({
  tasks: defineTable({
    ...
    userId: v.string(), // Link to user who created the task (non-optional)
    teamId: v.string(), // Team that owns this task
  ...
  taskRuns: defineTable({
    ...
    userId: v.string(), // Link to user who created the run (non-optional)
    teamId: v.string(), // Team that owns this task run
  ...
  comments: defineTable({
    ...
    teamId: v.string(), // Team that owns this comment
