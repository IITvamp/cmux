...
RUN bun --version && bunx --version
RUN bun add -g @openai/codex@0.23.0 @anthropic-ai/claude-code@1.0.83 @google/gemini-cli@0.1.21 opencode-ai@latest codebuff @devcontainers/cli @sourcegraph/amp
